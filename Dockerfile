...
# Base image
# Using Nodes' official image with Alpine, latest version
...
# Defining custom arguments for build command
ARG envid 
ARG appurl
ARG authurl
...
# Production image
# Using Nginx's official image with Alpine, latest version
